...
## Stage 12
            ...
            if stagenum == '12':
                ...
                while(not IRsensorque.empty()):
                    CLOSE = IRsensorque.get()
                #Actual trial. Continually searches for signal until recieved.
                while Trig != 20 and Trig != 30 and count < 8200: #Trig != 150 and Trig != 20 and Trig != 150 and Trig != 200 and Trig != 30:
                    Trig = 0
                    if sensorthread.is_alive():
                        if(not IRsensorque.empty()):
                            Trig = IRsensorque.get()
...
## Stage 23
            ...
            if stagenum == '23':
                if TrialId[x] == 1:
                    ...
                    while(not IRsensorque.empty()):
                        CLOSE = IRsensorque.get()
                    while Trig != 15 and Trig != 200 and Trig != 30 and count < 5900:
                        Trig = 0
                        if sensorthread.is_alive():
                            if(not IRsensorque.empty()):
                                Trig = IRsensorque.get()
...
## Stage 24
            ...
            if stagenum == '24':
                ...
                if TrialId[x] == 1:
                    ...
                    while(not IRsensorque.empty()):
                        CLOSE = IRsensorque.get()
                    while Trig != 150 and Trig != 20 and Trig != 30 and count < 5900:
                        Trig = 0
                        if sensorthread.is_alive():
                            if(not IRsensorque.empty()):
                                Trig = IRsensorque.get()
