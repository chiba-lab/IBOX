                        ...
                        for i in range(0,(delay-3)*10):
                            ...
                            if sensorthread.is_alive():
                                ...
                                if(not IRsensorque.empty()):
                                    Trig = IRsensorque.get()
## Stage 23
            # Air psudo-randomly alternates between self (trial id = 1) and friend/other (trial id = 3).
                        ...
                        for i in range(0,(delay-3)*10):
                            ...
                            if sensorthread.is_alive():
                                ...
                                if(not IRsensorque.empty()):
                                    Trig = IRsensorque.get()
## Stage 24
            # Air psuedo-randomly alternates between self and other.
            # Ports 150 and 20 turn off for self. Port 200 turns off for other.
            if stagenum == '24':
